...
// Check if $conn exists and is alive. If not, re-establish the connecti            <?php
...
if (isset($_SESSION['user_id'])) {
    ...
    $stmt->close();
    if ($result['count'] == 0) {
        $showMembershipLink = true; // Show only if logged in and no application exists
    }
}
