<?php
// Optionally include header and sidebar if your site layout requires it
include('header.php');
include('sidebar.php');
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        /* FAQ Hero Section Styles based on about.php */
        .faq-hero {
            position: relative;
