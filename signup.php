...
header("Content-Security-Policy: default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://static.cloudflareinsights.com 'nonce-$csp_nonce'; style-src 'self' https://cdn.jsdelivr.net 'nonce-$csp_nonce'; img-src 'self' data:; font-src 'self'");
