...
<div id="sidebar" class="sidebar sidebar-collapsed p-3">
    <nav class="nav flex-column">
        <a href="/admin/dashboard" class="nav-link <?php echo $currentPage === 'dashboard.php' ? 'active' : ''; ?>">
            <i class="bi bi-speedometer2"></i> <span>Overview</span>
        </a>
        <a href="/admin/users" class="nav-link <?php echo $currentPage === 'users.php' ? 'active' : ''; ?>">
            <i class="bi bi-people"></i> <span>Users</span>
        </a>
        <a href="/admin/reports" class="nav-link <?php echo $currentPage === 'reports.php' ? 'active' : ''; ?>">
            <i class="bi bi-file-earmark-bar-graph"></i> <span>Reports</span>
        </a>
        <a href="/admin/content_manager"
        ...
        <a href="/admin/payments" class="nav-link <?php echo $currentPage === 'payments.php' ? 'active' : ''; ?>">
            <i class="bi bi-credit-card"></i> <span>Payments</span>
        </a>
        <!-- Trainings tab added here -->
        <a href="/admin/trainings" class="nav-link <?php echo $currentPage === 'trainings.php' ? 'active' : ''; ?>">
            <i class="bi bi-mortarboard"></i> <span>Trainings</span>
        </a>
        <a href="/admin/assessments" class="nav-link <?php echo $currentPage === 'assessments.php' ? 'active' : ''; ?>">
            <i class="bi bi-card-checklist"></i> <span>Assessments and Evaluation</span>
        </a>
        <a href="/admin/membership_applications"
        ...
        <a href="/admin/membership_status"
        ...
        <a href="/admin/member_requests_management"
        ...
        <a href="/admin/settings" class="nav-link <?php echo $currentPage === 'settings.php' ? 'active' : ''; ?>">
