    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderUsersTable() {
            ...
            Object.values(paymentsByUser).forEach(user => {
                ...
                tr.innerHTML = `
                        ...
                        <td>${user.email}</td>
                        <td><button class="btn btn-primary btn-sm" onclick="window.managePayments(${user.user_id})">Manage</button></td>
                    `;
        ...
        window.managePayments = function(userId) {
            ...
            user.payments.forEach(payment => {
                const tr = document.createElement('tr');
                // Build status dropdown in the Status column
                let statusDropdown =
                    ...
                    `</select>`;
                // Build action buttons: "View Details" and "Update Status" button.
                let actionsHTML =
                    `<button class="btn btn-info btn-sm" onclick='window.viewPaymentDetailsAdmin(${JSON.stringify(payment)})'>View Details</button>`;
                actionsHTML +=
                    ` <button class="btn btn-secondary btn-sm" onclick="window.updatePaymentStatus(${payment.payment_id})">Update Status</button>`;
                tr.innerHTML = `
