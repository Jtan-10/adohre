...
<head>
    ...
    <!-- Include face-api.js and faceValidation module only if face validation is enabled -->
                    ...
                    if (result.status) {
                        ...
                        if (!globalUserData.first_name || !globalUserData.last_name || !globalUserData
                            ...
                            if (faceValidationEnabled) {
                                ...
                                // Skip face validation and proceed directly to login
                                try {
                                    showLoading();
                                    const formData = new FormData();
                                    ...
                                    if (finalResult.status) {
                                        ...
                                        showModal('Error', 'Error finalizing login: ' + finalResult.message);
                                    }
                                } catch (error) {
                                    hideLoading();
                                    showModal('Error', 'Error finalizing login: ' + error.message);
                                }
                            }
                        }
                    } else {
