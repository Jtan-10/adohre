                  ...
                  <div class="content-item">
                    <div class="row">
                      ...
                      <div class="col-md-9">
                        ...
                        <h4>${article.title}</h4>
                        <div class="meta-info">
                          <i class="bi bi-person"></i> Author: ${article.author} <br>
                          <i class="bi bi-info-circle"></i> Created by: ${article.creator ? article.creator : 'Unknown'} <br>
                          <i class="bi bi-calendar"></i> ${new Date(article.published_date).toLocaleDateString()} |
                          <i class="bi bi-hand-thumbs-up"></i> ${article.likes_count || 0} likes
                        </div>
                        <p>${article.excerpt}</p>
                        <div class="btn-group">
