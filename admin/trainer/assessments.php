...
<head>
    ...
    <style>
        ...
        /* Added Google Sheet Analytics styles */
        .sheet-card {
            margin-top: 20px;
            border: 1px solid #ddd;
            border-radius: 10px;
    ...
    <main class="container mt-4 mb-4">
        ...
        <div class="form-section">
            ...
            <form id="assessmentForm" method="POST">
                ...
                <!-- Added Google Sheet Analytics Section -->
                <div class="sheet-card">
                    ...
                    <div class="sheet-card-body">
                        <iframe class="sheet-iframe"
                            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS4QUctqUgDxzc4Ni1WtOkta8KEfWLQVdAiOYyMFmXflvPaOfdxLPBgdEtT88bzfTqwfi5U7Xv72Hk0/pubhtml?widget=true&amp;headers=false">
                        </iframe>
                    </div>
                </div>
