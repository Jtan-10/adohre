...
switch ($action) {
    ...
    case 'update_page_content':
        ...
        if ($page === 'home') {
            ...
            $allowed = ['about_hero_title', 'about_hero_subtitle', 'about_purpose_text', 'about_mission_text', 'about_vision_text', 'about_objectives_html', 'about_hero_image_url', 'about_sections_json', 'about_leadership_json', 'about_committees_json', 'about_objectives_bg_url', 'about_expertise_bg_url', 'about_org_structure_image_url'];
        } else {
            echo json_encode(['status' => false, 'message' => 'Unknown page']);
            break;
        }
