...
header("Content-Security-Policy: default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://meet.jit.si 'nonce-$nonce'; style-src 'self' https://cdn.jsdelivr.net 'sha256-aplL7vYwF1FNN+yXTOWH8+mfuVgRwdBPcoME8a8R1GA='; font-src 'self' https://cdn.jsdelivr.net; img-src 'self';");
