                ...
                <div class="col-md-6" id="revenue-stats-section">
                    <div class="card p-3">
                        ...
                        <div class="mt-3 small text-muted">
                            <div>Events Revenue: <span id="revenueEvents">...</span></div>
                            <div>Trainings Revenue: <span id="revenueTrainings">...</span></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card p-3">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Payments Pending / Completed / New / Overdue</td>
                                    <td>
                                        <span id="paymentsPending">0</span> /
                                        <span id="paymentsCompleted">0</span> /
                                        <span id="paymentsNew">0</span> /
                                        <span id="paymentsOverdue">0</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Consultations Open / Closed</td>
                                    <td>
                                        <span id="consultationsOpen">0</span> /
                                        <span id="consultationsClosed">0</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Membership Apps: Pending / Reviewed / Approved / Rejected</td>
                                    <td>
                                        <span id="appsPending">0</span> /
                                        <span id="appsReviewed">0</span> /
                                        <span id="appsApproved">0</span> /
                                        <span id="appsRejected">0</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                fetch('../backend/routes/analytics.php')
                    ...
                    .then(data => {
                        ...
                        if (data.status) {
                            ...
                            document.getElementById('totalPaymentsTable').innerText = data.data.total_payments || 0;
                            document.getElementById('paymentsPending').innerText = data.data.payments_pending || 0;
                            document.getElementById('paymentsCompleted').innerText = data.data.payments_completed || 0;
                            document.getElementById('paymentsNew').innerText = data.data.payments_new || 0;
                            document.getElementById('paymentsOverdue').innerText = data.data.payments_overdue || 0;
                            document.getElementById('consultationsOpen').innerText = data.data.consultations_open || 0;
                            document.getElementById('consultationsClosed').innerText = data.data.consultations_closed || 0;
                            document.getElementById('appsPending').innerText = data.data.membership_pending || 0;
                            document.getElementById('appsReviewed').innerText = data.data.membership_reviewed || 0;
                            document.getElementById('appsApproved').innerText = data.data.membership_approved || 0;
                            document.getElementById('appsRejected').innerText = data.data.membership_rejected || 0;
                                ...
                                revenueChart: function() {
                                    try {
                                        ...
                                        new Chart(revenueCtx, {
                                            type: 'doughnut',
                                            data: {
                                                labels: ['Events', 'Trainings'],
                                                datasets: [{
                                                    data: [data.data.revenue_events || 0, data.data.revenue_trainings || 0],
                                        ...
                                        document.getElementById('revenueEvents').innerText = (data.data.revenue_events || 0).toFixed(2);
                                        document.getElementById('revenueTrainings').innerText = (data.data.revenue_trainings || 0).toFixed(2);
